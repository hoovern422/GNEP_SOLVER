...
from GNEP_environments.env1.training_environment import TrainingEnv
from GNEP_environments.env1.playing_environment import PlayingEnv
...
if __name__ == '__main__':
    ...
    x_agent = Agent(action_scaling_factor, actor_lr, gamma, action_space,
                    checkpoint_dir='models/problem1_checkpoints/x_agent')
    y_agent = Agent(action_scaling_factor, actor_lr, gamma, action_space,
                    checkpoint_dir='models/problem1_checkpoints/y_agent')
    ...
    if training_flag:
        ...
        critic = Critic(critic_lr, gamma,
                        checkpoint_critic_dir='models/problem1_checkpoints/critic')
        ...
        plot_learning_curve(episode_tracker, avg_rewards, 'problem1')
    ...
    if playing_flag:
        ...
        plot_nash_eq(x_sols, y_sols, 'problem1')
        plot_heatmap(x_sols, y_sols, 'problem1')
